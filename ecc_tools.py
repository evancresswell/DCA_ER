...
def di_dict2mat(pydca_score, cols_removed, s_index):
...
# -------------------------------------------------------------------------------------------------------------------- #
# -------------------------------------------------------------------------------------------------------------------- #
def npy2fa(pfam_id, npy_infile, pdb_ref_file, ipdb, preprocess=False, gap_seqs=.2, gap_cols=.2, prob_low=.004, conserved_cols=.9):
